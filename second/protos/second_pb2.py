...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1asecond/protos/second.proto\x12\rsecond.protos\x1a\x1asecond/protos/losses.proto\x1a\x1dsecond/protos/box_coder.proto\x1a\x1asecond/protos/target.proto\x1a#second/protos/voxel_generator.proto\"\xf1\r\n\x08VoxelNet\x12\x36\n\x0fvoxel_generator\x18\x01 \x01(\x0b\x32\x1d.second.protos.VoxelGenerator\x12N\n\x17voxel_feature_extractor\x18\x02 \x01(\x0b\x32-.second.protos.VoxelNet.VoxelFeatureExtractor\x12P\n\x18middle_feature_extractor\x18\x03 \x01(\x0b\x32..second.protos.VoxelNet.MiddleFeatureExtractor\x12(\n\x03rpn\x18\x04 \x01(\x0b\x32\x1b.second.protos.VoxelNet.RPN\x12\x16\n\x0euse_iou_branch\x18\x05 \x01(\x08\x12(\n\x03iou\x18\x06 \x01(\x0b\x32\x1b.second.protos.VoxelNet.IOU\x12\x19\n\x11use_sigmoid_score\x18\x07 \x01(\x08\x12!\n\x04loss\x18\x08 \x01(\x0b\x32\x13.second.protos.Loss\x12\x1f\n\x17\x65ncode_rad_error_by_sin\x18\t \x01(\x08\x12\"\n\x1a\x65ncode_background_as_zeros\x18\n \x01(\x08\x12\x1a\n\x12use_aux_classifier\x18\x0b \x01(\x08\x12\x16\n\x0euse_rotate_nms\x18\x0c \x01(\x08\x12\x1b\n\x13use_multi_class_nms\x18\r \x01(\x08\x12\x18\n\x10nms_pre_max_size\x18\x0e \x01(\r\x12\x19\n\x11nms_post_max_size\x18\x0f \x01(\r\x12\x1b\n\x13nms_score_threshold\x18\x10 \x01(\x02\x12\x19\n\x11nms_iou_threshold\x18\x11 \x01(\x02\x12\x1f\n\x17post_center_limit_range\x18\x12 \x03(\x02\x12 \n\x18use_direction_classifier\x18\x13 \x01(\x08\x12\x1d\n\x15\x64irection_loss_weight\x18\x14 \x01(\x02\x12\x18\n\x10pos_class_weight\x18\x15 \x01(\x02\x12\x18\n\x10neg_class_weight\x18\x16 \x01(\x02\x12<\n\x0eloss_norm_type\x18\x17 \x01(\x0e\x32$.second.protos.VoxelNet.LossNormType\x12\x0f\n\x07use_bev\x18\x18 \x01(\x08\x12\x1c\n\x14without_reflectivity\x18\x19 \x01(\x08\x12\x1e\n\x16\x65ncode_angle_to_vector\x18\x1a \x01(\x08\x12*\n\tbox_coder\x18\x1b \x01(\x0b\x32\x17.second.protos.BoxCoder\x12\x36\n\x0ftarget_assigner\x18\x1c \x01(\x0b\x32\x1d.second.protos.TargetAssigner\x12\x13\n\x0blidar_input\x18\x1d \x01(\x08\x12\x1a\n\x12num_point_features\x18\x1e \x01(\r\x1az\n\x15VoxelFeatureExtractor\x12\x19\n\x11module_class_name\x18\x01 \x01(\t\x12\x13\n\x0bnum_filters\x18\x02 \x03(\r\x12\x15\n\rwith_distance\x18\x03 \x01(\x08\x12\x1a\n\x12num_input_features\x18\x04 \x01(\r\x1a\xa0\x01\n\x16MiddleFeatureExtractor\x12\x19\n\x11module_class_name\x18\x01 \x01(\t\x12\x19\n\x11num_filters_down1\x18\x02 \x03(\r\x12\x19\n\x11num_filters_down2\x18\x03 \x03(\r\x12\x1a\n\x12num_input_features\x18\x04 \x01(\r\x12\x19\n\x11\x64ownsample_factor\x18\x05 \x01(\r\x1a\xdf\x01\n\x03RPN\x12\x19\n\x11module_class_name\x18\x01 \x01(\t\x12\x12\n\nlayer_nums\x18\x02 \x03(\r\x12\x15\n\rlayer_strides\x18\x03 \x03(\r\x12\x13\n\x0bnum_filters\x18\x04 \x03(\r\x12\x18\n\x10upsample_strides\x18\x05 \x03(\r\x12\x1c\n\x14num_upsample_filters\x18\x06 \x03(\r\x12\x15\n\ruse_groupnorm\x18\x07 \x01(\x08\x12\x12\n\nnum_groups\x18\x08 \x01(\r\x12\x1a\n\x12num_input_features\x18\t \x01(\r\x1aQ\n\x03IOU\x12\x19\n\x11module_class_name\x18\x01 \x01(\t\x12\x13\n\x0bnum_filters\x18\x02 \x03(\x05\x12\x1a\n\x12num_input_features\x18\x03 \x01(\x05\"R\n\x0cLossNormType\x12\x15\n\x11NormByNumExamples\x10\x00\x12\x16\n\x12NormByNumPositives\x10\x01\x12\x13\n\x0fNormByNumPosNeg\x10\x02\x62\x06proto3')
  ,
...
_VOXELNET_IOU = _descriptor.Descriptor(
  name='IOU',
  full_name='second.protos.VoxelNet.IOU',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='module_class_name', full_name='second.protos.VoxelNet.IOU.module_class_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_filters', full_name='second.protos.VoxelNet.IOU.num_filters', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_input_features', full_name='second.protos.VoxelNet.IOU.num_input_features', index=2,
...
_VOXELNET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_iou_branch', full_name='second.protos.VoxelNet.use_iou_branch', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='iou', full_name='second.protos.VoxelNet.iou', index=5,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_aux_classifier', full_name='second.protos.VoxelNet.use_aux_classifier', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_rotate_nms', full_name='second.protos.VoxelNet.use_rotate_nms', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_multi_class_nms', full_name='second.protos.VoxelNet.use_multi_class_nms', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_pre_max_size', full_name='second.protos.VoxelNet.nms_pre_max_size', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_post_max_size', full_name='second.protos.VoxelNet.nms_post_max_size', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_score_threshold', full_name='second.protos.VoxelNet.nms_score_threshold', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_iou_threshold', full_name='second.protos.VoxelNet.nms_iou_threshold', index=16,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_direction_classifier', full_name='second.protos.VoxelNet.use_direction_classifier', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='direction_loss_weight', full_name='second.protos.VoxelNet.direction_loss_weight', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pos_class_weight', full_name='second.protos.VoxelNet.pos_class_weight', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='neg_class_weight', full_name='second.protos.VoxelNet.neg_class_weight', index=21,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='loss_norm_type', full_name='second.protos.VoxelNet.loss_norm_type', index=22,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_bev', full_name='second.protos.VoxelNet.use_bev', index=23,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='without_reflectivity', full_name='second.protos.VoxelNet.without_reflectivity', index=24,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='encode_angle_to_vector', full_name='second.protos.VoxelNet.encode_angle_to_vector', index=25,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='box_coder', full_name='second.protos.VoxelNet.box_coder', index=26,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='target_assigner', full_name='second.protos.VoxelNet.target_assigner', index=27,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lidar_input', full_name='second.protos.VoxelNet.lidar_input', index=28,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_point_features', full_name='second.protos.VoxelNet.num_point_features', index=29,
  ...
  nested_types=[_VOXELNET_VOXELFEATUREEXTRACTOR, _VOXELNET_MIDDLEFEATUREEXTRACTOR, _VOXELNET_RPN, _VOXELNET_IOU, ],
  enum_types=[
...
_VOXELNET_IOU.containing_type = _VOXELNET
...
_VOXELNET.fields_by_name['iou'].message_type = _VOXELNET_IOU
...
VoxelNet = _reflection.GeneratedProtocolMessageType('VoxelNet', (_message.Message,), dict(
  ...
  IOU = _reflection.GeneratedProtocolMessageType('IOU', (_message.Message,), dict(
    DESCRIPTOR = _VOXELNET_IOU,
    __module__ = 'second.protos.second_pb2'
    # @@protoc_insertion_point(class_scope:second.protos.VoxelNet.IOU)
    ))
  ,
...
_sym_db.RegisterMessage(VoxelNet.IOU)
