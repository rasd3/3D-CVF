...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1asecond/protos/target.proto\x12\rsecond.protos\x1a\x1bsecond/protos/anchors.proto\x1a\x1esecond/protos/similarity.proto\"\xc9\x02\n\x0eTargetAssigner\x12\x43\n\x11\x61nchor_generators\x18\x01 \x03(\x0b\x32(.second.protos.AnchorGeneratorCollection\x12 \n\x18sample_positive_fraction\x18\x02 \x01(\x02\x12\x13\n\x0bsample_size\x18\x03 \x01(\r\x12\x16\n\x0euse_rotate_iou\x18\x04 \x01(\x08\x12\x12\n\nclass_name\x18\x05 \x01(\t\x12O\n\x1cregion_similarity_calculator\x18\x06 \x01(\x0b\x32).second.protos.RegionSimilarityCalculator\x12\x1c\n\x14use_iou_param_partaa\x18\x07 \x01(\x08\x12 \n\x18use_nms_score_multiplied\x18\x08 \x01(\x08\x62\x06proto3')
  ,
...
_TARGETASSIGNER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_iou_param_partaa', full_name='second.protos.TargetAssigner.use_iou_param_partaa', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_nms_score_multiplied', full_name='second.protos.TargetAssigner.use_nms_score_multiplied', index=7,
