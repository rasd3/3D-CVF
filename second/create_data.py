...
def create_kitti_info_file(data_path,
    ...
    if scene_num is not None:
        test_img_ids = _read_imageset_file("/home/spalab/jhyoo/dataset/KITTI_raw/2011_09_26_drive_"+scene_num+"_sync/testing/test.txt")
    else:
...
def create_reduced_point_cloud(data_path,
    ...
    if test_info_path is None:
        f_name = 'kitti_infos_test.pkl' if scene_num is None else 'kitti_infos_test_'+scene_num+'.pkl'
        test_info_path = pathlib.Path(data_path) / f_name
