...
def build(loss_config):
  ...
  if loss_config.use_iou_loss:
    iou_loss = _build_classification_loss(
        loss_config.iou_loss)
    iou_weight = loss_config.iou_weight
  else:
    iou_loss, iou_weight = None, None
  ...
  return (classification_loss, localization_loss, iou_loss,
          classification_weight, localization_weight, iou_weight,
          hard_example_miner)
