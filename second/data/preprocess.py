...
def prep_pointcloud(input_dict,
    ...
    idxs_norm = _get_fview_idx(calib, f_view, rot_noise, scal_noise)
...
def _read_and_process_f_view(f_view):
    ...
    return f_view
def _get_fview_idx(calib, f_view, rot_noise, scal_noise):
    import torch
    # idx_num = [-17., -25., -10.]
    idx_num = [-17., -19., -15.]
    idx_all = []
    for i in range(len(idx_num)):
        idxs, idxs_norm_0 = make_idx.get_projected_idx([704.,800.], calib, f_view.shape, idx_num[i], rot_noise, scal_noise, 4.)
